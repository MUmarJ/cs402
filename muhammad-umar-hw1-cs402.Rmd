...
barplot(addressFreq1, main="Frequency of address operations in Spice", 
...
barplot(addressFreq2, main="Frequency of address operations in Tex", 
        xlab = "Address", ylab = "Access Count")
```
...
maxX1<-max(table(x1))
{bp1 <- barplot(
  table(data1$V1), xaxt="n", main="Frequency of operations in Spice",
