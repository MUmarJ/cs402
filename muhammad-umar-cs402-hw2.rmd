...
Parallel execution time = `r parallelCyclesSum`/p/`r Ghz` + `r branchCycles`/`r Ghz`
...
Parallel Execution Time = `r parallelCyclesSum2`/p/`r Ghz` + `r branchCycles`/`r Ghz`
...
= `r {instructionsQ122P2 = (0.225 * (3.0*10^9))/0.75; instructionsQ122P2}` instructions
